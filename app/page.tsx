...
const conceptItems = [
  { icon: "💳", label: "Smart Budget", desc: "Real-time price tracking across 200+ providers" },
  { icon: "🗺️", label: "AI Itinerary", desc: "Built around your travel style and dates" },
  { icon: "🎵", label: "Events Feed", desc: "Concerts and experiences at your destination" },
  { icon: "🛒", label: "One Checkout", desc: "Flights, stays and tours in one booking" },
  { icon: "✦", label: "Personalization", desc: "Learns your taste — gets better every trip" },
];
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-2xl">
          <motion.h1
            ...
            className="text-white font-spaceGrotesk font-black tracking-tighter mb-4 select-none"
          ...
          <motion.p
            ...
            className="text-white/70 text-base tracking-wide mb-8"
          >
            The AI travel planner that does it all.
          </motion.p>
