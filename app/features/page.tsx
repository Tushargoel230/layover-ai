    ...
    mock: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 mt-4 text-xs">
          <div className="p-2 bg-bg border border-border rounded-lg">✈️ Flights $600</div>
          ...
          <div className="p-2 bg-bg border border-border rounded-lg">🎟️ Activities $200</div>
        </div>
      </div>
    ),
  },
  ...
  },
  {
    ...
    mock: (
      <div className="space-y-3 text-sm">
        {[{e:"🎵",n:"Coldplay",d:"June 15",p:"€85"},{e:"🎷",n:"Jazz Festival",d:"June 16–19",p:"€20"},{e:"🏛️",n:"Colosseum Night",d:"June 20",p:"€45"}].map(r=>(
  ...
  },
  {
    ...
    mock: (
      <div className="grid grid-cols-3 gap-2">
        {["🏛️","🍝","🌇","☕","🎨","🌙","🍷","🛵","🌅"].map((e,i)=>(
          <div key={i} className="aspect-square bg-bg border border-border rounded-lg flex items-center justify-center text-2xl">{e}</div>
        ))}
      </div>
    ),
  },
