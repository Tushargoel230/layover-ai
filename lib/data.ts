...
export const events: Event[] = [
  ...
  { name: "Ancient Rome by Night", venue: "Colosseum area", date: "June 20, 2026", price: "€45", tag: "cultural", emoji: "🏛️" },
];
...
export const featuredTrips: FeaturedTrip[] = [
  {
    ...
    country: "Croatia",
    emoji: "🇭🇷",
    img: "https://images.unsplash.com/photo-1555990538-c4f5e0f5d2a0?w=800&auto=format&fit=crop",
    ...
    travelers: 2,
    weatherCity: "Split",
    tags: ["beach", "history", "islands", "sailing"],
    itinerary: [
      { day: 1, title: "Arrive Split", activities: [{ time: "afternoon", label: "Diocletian's Palace walk", cost: 0 }, { time: "evening", label: "Waterfront dinner", cost: 45 }] },
      { day: 2, title: "Hvar Island", activities: [{ time: "morning", label: "Ferry to Hvar", cost: 20 }, { time: "afternoon", label: "Hvar Town beaches", cost: 0 }, { time: "evening", label: "Sunset cocktails", cost: 35 }] },
      { day: 3, title: "Brač & Zlatni Rat Beach", activities: [{ time: "morning", label: "Ferry to Brač", cost: 15 }, { time: "afternoon", label: "Zlatni Rat beach", cost: 0 }, { time: "evening", label: "Seafood restaurant", cost: 50 }] },
      { day: 4, title: "Dubrovnik", activities: [{ time: "morning", label: "Bus to Dubrovnik", cost: 30 }, { time: "afternoon", label: "Old Town walls walk", cost: 25 }, { time: "evening", label: "Lokanda Peskarija dinner", cost: 55 }] },
      { day: 5, title: "Island Hopping", activities: [{ time: "morning", label: "Boat tour to Elafiti Islands", cost: 60 }, { time: "afternoon", label: "Swimming & snorkeling", cost: 0 }, { time: "evening", label: "Back to Dubrovnik, cocktails", cost: 30 }] },
      { day: 6, title: "Kotor, Montenegro", activities: [{ time: "morning", label: "Day trip to Kotor Bay", cost: 40 }, { time: "afternoon", label: "Old Town Kotor", cost: 0 }, { time: "evening", label: "Return + farewell dinner", cost: 50 }] },
      { day: 7, title: "Departure", activities: [{ time: "morning", label: "Dubrovnik morning stroll", cost: 0 }, { time: "afternoon", label: "Airport transfer", cost: 35 }, { time: "evening", label: "Fly home", cost: 0 }] },
    ],
  },
  {
    id: "paris",
...
export const languagePacks: Record<string, LanguagePack> = {
  Croatia: {
    ...
    phrases: [
      { category: "Greetings", english: "Hello", local: "Bok", phonetic: "bock", tip: "Very casual, like 'hey'" },
      { category: "Greetings", english: "Good morning", local: "Dobro jutro", phonetic: "DOH-broh YOO-troh", tip: "Use before noon" },
      { category: "Greetings", english: "Thank you", local: "Hvala", phonetic: "HVAH-lah", tip: "H is breathy, like 'huge'" },
      { category: "Greetings", english: "Please", local: "Molim", phonetic: "MOH-leem", tip: "Also means 'you're welcome'" },
      { category: "Food", english: "The bill, please", local: "Račun, molim", phonetic: "RAH-choon MOH-leem", tip: "Essential in restaurants" },
      { category: "Food", english: "Delicious!", local: "Odlično!", phonetic: "OD-leech-noh", tip: "Say with enthusiasm!" },
      { category: "Food", english: "Water, please", local: "Vode, molim", phonetic: "VOH-deh MOH-leem", tip: "Specify 'mineralna' for sparkling" },
      { category: "Transport", english: "Where is...?", local: "Gdje je...?", phonetic: "GDYEH yeh", tip: "G-D sounds run together" },
      { category: "Transport", english: "Bus station", local: "Autobusni kolodvor", phonetic: "ow-toh-BOOS-nee", tip: "Often shortened to 'kolodvor'" },
      { category: "Emergency", english: "Help!", local: "Upomoć!", phonetic: "OO-poh-moach", tip: "Shout loudly if needed" },
      { category: "Emergency", english: "I need a doctor", local: "Trebam liječnika", phonetic: "TREH-bahm lyeh-CHNEEK-ah", tip: "Point to yourself while saying" },
      { category: "Greetings", english: "Goodbye", local: "Doviđenja", phonetic: "doh-vee-JEN-yah", tip: "Formal farewell — bok works for casual" },
    ],
  },
  France: {
