    ...
    <>
      <header className={`sticky top-0 z-40 transition-all duration-300 ${
        ...
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-4">
          {/* Logo */}
          <Link href="/" className={`flex items-center select-none h-10 transition-opacity duration-300 ${transparent ? "opacity-100" : "opacity-100"}`}>
            <div className="font-black font-spaceGrotesk text-xl tracking-tighter" style={{ letterSpacing: '-0.03em', color: "#27B4F5" }}>
              ATLAS.AI
            </div>
          </Link>
