      ...
      <AnimatePresence mode="wait">
        ...
        {step === "loading" && (
          <motion.div key="loading" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="mt-6 text-muted">Atlas AI is planning your trip...</div>
          </motion.div>
        )}
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4">
                  {outfits.map((o) => (
                    <Card key={o.day} className="p-5 min-w-[220px] max-w-[220px] flex-shrink-0">
                      <div className="text-xs text-muted uppercase tracking-widest mb-2">Day {o.day}</div>
                      <div className="grid grid-cols-3 gap-2 my-4">
                        <div className="aspect-square bg-gradient-to-br from-amber-200 to-orange-300 rounded-lg flex items-center justify-center text-3xl">👕</div>
                        <div className="aspect-square bg-gradient-to-br from-blue-200 to-blue-400 rounded-lg flex items-center justify-center text-3xl">👖</div>
                        <div className="aspect-square bg-gradient-to-br from-green-200 to-teal-300 rounded-lg flex items-center justify-center text-3xl">👟</div>
                      </div>
                      <div className="text-sm mb-4 text-text font-medium">{o.items}</div>
